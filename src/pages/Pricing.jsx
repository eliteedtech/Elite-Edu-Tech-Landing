...
function App() {
  return (
   ...
   <div className=" pt-20 pb-10  mx-auto bg-[#00356B]/15 dark:bg-gray-200/15 ">
     <div className=" mx-auto ">
    <h1 className=" text-center text-3xl md:text-4xl font-extrabold text-indigo-900 dark:text-white mb-4">Simple, Transparent Pricing</h1>
