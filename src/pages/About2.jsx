            ...
            <div data-aos="zoom-out-down" className="">
              {misVis.map((mis, id) => (
                <div key={id} className="">
                  <h1 className="text-2xl font-bold text-[#00356B] dark:text-[#A51C30] mb-4">{mis.title}</h1>
                  <p className='text-gray-600 dark:text-gray-400 mb-3'>{mis.text}</p>
                </div>))}
            </div>
            <div className="sm:grid-cols-1 mt-8 sm:mb-10 grid md:grid-cols-3 lg:grid-cols-3">
              {misVisCard.map((data, id) => (
                <div data-aos="zoom-out-up" key={id} className='rounded-lg shadow-md hover:shadow-lg border-1 border-gray-100 p-6 m-2' >
                  ...
                  <h2 className='font-bold text-lg mb-3 text-[#00356B] dark:text-[#A51C30] '>{data.title}</h2>
                  <p className="text-gray-600 dark:text-gray-400 text-[13px] ">{data.text}</p>
                </div>
              ))}
            </div>
          </div>
