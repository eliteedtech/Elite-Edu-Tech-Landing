...
export default function TestimonialsCard({ image, rating, testimony, testifier, testifierInfo }) {
    ...
    return (
      <div
        ...
        data-aos="fade-up "
      >
        <div className="flex dark:shadow-xl shadow-2xl py-5 px-6   flex-col rounded-xl bg-white dark:bg-gray-950 w-full justify-center items-center dark:rounded-xl dark:border dark:border-[#A51C30]  dark:shadow-[0_0_10px_0_rgba(0,0,0,0.1)] dark:rounded-xl ">
