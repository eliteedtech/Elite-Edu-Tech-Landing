...
function Button(props) {
    ...
    if(props.type == "btn-outline"){
        ...
        btnStyle ='w-full bg-indigo-600 text-white p-[8px] px-4 min-w-24 font-sans rounded-full transition duration-200 cursor-pointer shadow-2xl cursor-pointer hover:bg-indigo-700/50'
    }
